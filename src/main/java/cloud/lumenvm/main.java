    ...
    private void sendWebhook(String title, String description, String color) {
        try {
            ...
            jsonPayload.append("\"fields\": [")
                    .append("{\"name\": \"Time Zone\", \"value\": \"").append(TZ).append("\", \"inline\": true},")
                    .append("{\"name\": \"Server Memory\", \"value\": \"").append(SERVER_MEMORY).append("MB\", \"inline\": true},")
                    .append("{\"name\": \"Server IP\", \"value\": \"").append(SERVER_IP).append("\", \"inline\": true},")
                    .append("{\"name\": \"Server Port\", \"value\": \"").append(SERVER_PORT).append("\", \"inline\": true},")
                    .append("{\"name\": \"Server Location\", \"value\": \"").append(P_SERVER_LOCATION).append("\", \"inline\": true},")
                    .append("{\"name\": \"Server UUID\", \"value\": \"```").append(P_SERVER_UUID).append("```\", \"inline\": true},")
                    .append("{\"name\": \"Server Version\", \"value\": \"").append(getServer().getVersion()).append("\", \"inline\": true},")
                    .append("{\"name\": \"Number of Plugins\", \"value\": \"").append(getServer().getPluginManager().getPlugins().length).append("\", \"inline\": true}")
                    .append("],");

            jsonPayload.append("\"footer\": {")
                    .append("\"text\": \"LumenMC Monitor | ").append(LocalDateTime.now()).append("\"")
                    .append("}")
                    .append("}]")
                    .append("}");
            ...
            getLogger().info("Webhook response code: " + responseCode);
