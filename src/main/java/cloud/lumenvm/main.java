...
public final class main extends JavaPlugin {
    ...
    private void sendWebhook(String title, String description, String color) {
        try {
            ...
            jsonPayload.append("{")
                    ...
                    .append("\"avatar_url\": \"")
                    .append(WEBHOOK_AVATAR != null ? WEBHOOK_AVATAR : "https://cdn.lumenvm.cloud/lumen-avatar.png")
                    .append("\",")
                    .append("\"embeds\": [{")
                    ...
                    .append("\"url\": \"")
                    .append(WEBHOOK_IMAGE != null ? WEBHOOK_IMAGE : "https://cdn.lumenvm.cloud/lumenmc-banner.png")
                    .append("\"")
                    .append("},");
            jsonPayload.append("\"fields\": [").append("{\"name\": \"Time Zone\", \"value\": \"").append(TZ)
                    .append("\", \"inline\": true},")
                    .append("{\"name\": \"Server Memory\", \"value\": \"").append(SERVER_MEMORY)
                    .append("MB\", \"inline\": true},").append("{\"name\": \"Server IP\", \"value\": \"")
                    .append(SERVER_IP).append("\", \"inline\": true},")
                    .append("{\"name\": \"Server Port\", \"value\": \"").append(SERVER_PORT)
                    .append("\", \"inline\": true},")
                    .append("{\"name\": \"Server Location\", \"value\": \"").append(P_SERVER_LOCATION)
                    .append("\", \"inline\": true},").append("{\"name\": \"Server UUID\", \"value\": \"```")
                    .append(P_SERVER_UUID).append("```\", \"inline\": true},")
                    .append("{\"name\": \"Server Version\", \"value\": \"").append(getServer().getVersion())
                    .append("\", \"inline\": true},")
                    .append("{\"name\": \"Number of Plugins\", \"value\": \"")
                    .append(getServer().getPluginManager().getPlugins().length).append("\", \"inline\": true}")
                    .append("],");
            ...
            jsonPayload.append("\"footer\": {")
                    ...
                    .append("}]")
                    .append("}");
            System.out.println("Payload: " + jsonPayload.toString());
